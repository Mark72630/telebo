...
token 2016377496:AAFxJk0QVX7U5WDRdN5XFg6r4FGQPmQWC38= config["tgbot"]["2016377496:AAFxJk0QVX7U5WDRdN5XFg6r4FGQPmQWC38"]
get_id @MarIyyyyyk= config["tgbot"]["@MarIyyyyyk"]
admin_id = @MarIyyyyyk[]
if "," in get_id:
	get_id = get_id.split(",")
	for a in get_id:
	...
	try:
		admin_id = [int(@MarIyyyyyk)]
	except ValueError:
		admin_id =[0]
		print("*****@MarIyyyyyk*****")

bot = telebot.TeleBot(2016377496:AAFxJk0QVX7U5WDRdN5XFg6r4FGQPmQWC38)
